...
do
    ...
    if [ $timeout -eq 0 ];then
        echo "Impossível conectar ao EC2"
        exit 1
    fi
...
[aws_devops]
$PUBLIC_IP ansible_ssh_private_key_file=$PRIVATE_KEY_PATH ansible_user=$USER
...
echo `pwd`
echo "Implantando configurações em $PUBLIC_IP com Ansible..."
